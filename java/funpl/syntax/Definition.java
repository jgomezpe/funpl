...
public class Definition extends Rule{
	...
	return t.type()==FunConstants.FUNCTION;
    }
	...
	pair.add(parser.rule(FunConstants.COMMAND).analize(lexer,current));
	...
	pair.add(parser.analize(FunConstants.EXPRESSION,lexer));
